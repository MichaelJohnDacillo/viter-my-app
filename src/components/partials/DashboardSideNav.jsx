            ...
            <ul className='py-5'>
                <li className="mb-3">
                    <div className="py-1 px-5 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
                        <a href="#header" className='flex items-center gap-2 w-full'>Header</a>
                    </div>
                </li>
                <li className="mb-3">
                    <div className="py-1 px-5 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
                        <a href="#banner" className='flex items-center gap-2 w-full'>Banner</a>
                    </div>
                </li>
                <li className="mb-3">
                    <div className="py-1 px-5 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
                        <a href="#services" className='flex items-center gap-2 w-full'>Services</a>
                    </div>
                </li>
                <li className="mb-3">
                    <div className="py-1 px-5 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
                        <a href="#about" className='flex items-center gap-2 w-full'>About</a>
                    </div>
                </li>
                <li className="mb-3">
                    <div className="py-1 px-5 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
                        <a href="#testimonials" className='flex items-center gap-2 w-full'>Testimonials</a>
                    </div>
                </li>
                <li className="mb-3">
                    <div className="py-1 px-5 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
                        <a href="#contact" className='flex items-center gap-2 w-full'>Contact</a>
                    </div>
                </li>
                <li className="mb-3">
                    <div className="py-1 px-5 flex items-center justify-between gap-2 hover:bg-primary transition-all ease-in-out duration-200 cursor-pointer">
                        <a href="#footer" className='flex items-center gap-2 w-full'>Footer</a>
                    </div>
                </li>
            </ul>
        </nav>
