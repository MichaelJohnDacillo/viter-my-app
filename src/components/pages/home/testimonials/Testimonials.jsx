        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 bg-white rounded-full shadow-md hover:bg-gray-100"
            >
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 -ml-4 bg-white rounded-full shadow-md hover:bg-gray-100"
            >
